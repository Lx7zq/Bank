...
const main = () => {
  // สร้างอินสแตนซ์
  const customer1 = new Customer("John Doe", "123 ถนนเมน", "123-456-7890", "MARK@example.com");
  const bank1 = new Bank("SE Bank", "456 NPRU", "ABC123");
  const account1 = new Account("123456789", 1000, "1234");
  const atm1 = new ATM("ATM SE", "SE Bank");
